  ...
  return (
    <div className="fixed inset-0 z-[100] bg-slate-900 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative">
        <div className="max-w-4xl w-full aspect-video bg-white rounded-2xl shadow-2xl p-12 flex flex-col justify-center relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8">{slides[slide].title}</h2>
          <div className="text-xl md:text-2xl text-slate-600 whitespace-pre-line leading-relaxed">
...
export const LandingPage = () => {
  ...
  return (
    <div className="bg-white flex flex-col min-h-screen font-sans">
      ...
      {/* 1. HERO SECTION */}
      <section className="bg-slate-50 pt-24 pb-32 border-b border-gray-200 text-center px-4 relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 border border-blue-200 text-blue-800 text-xs font-black mb-8 uppercase tracking-widest">
            <Shield className="w-4 h-4" /> ENGINEERS DAY CHALLENGE • PUBLIC BETA
          </div>
          <h1 className="text-6xl md:text-8xl font-black text-slate-900 tracking-tight leading-none mb-6">
            RoadGuard AI
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <a href="#how-it-works" className="w-full sm:w-auto px-8 py-4 bg-white border-2 border-slate-200 hover:border-slate-300 text-slate-700 rounded-xl font-bold text-lg flex items-center justify-center gap-2 transition-transform hover:-translate-y-1">
              How It Works
            </a>
          </div>
        </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-sm font-black text-blue-600 tracking-widest uppercase mb-4">The Problem</h2>
            <p className="text-3xl md:text-4xl font-bold text-slate-900 max-w-3xl mx-auto leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-slate-50 border border-slate-100 p-8 rounded-2xl">
      ...
      <section id="how-it-works" className="py-24 px-4 bg-slate-50 border-b border-slate-200 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900 mb-4">HOW ROADGUARD AI WORKS</h2>
          </div>
          
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center relative gap-8 lg:gap-0">
            {/* Connecting line (Desktop) */}
            <div className="hidden lg:block absolute top-8 left-0 w-full h-1 bg-slate-200 z-0"></div>
            ...
            {[
              ...
              <div key={i} className="relative z-10 flex flex-col lg:items-center w-full lg:w-1/6 group">
                <div className="flex flex-row lg:flex-col items-center gap-6 lg:gap-4">
                  <div className="w-16 h-16 bg-white border-4 border-slate-100 rounded-full flex items-center justify-center font-black text-xl text-blue-600 shadow-sm group-hover:border-blue-200 transition-colors flex-shrink-0">
                    {step.num}
                  </div>
          ...
          <div className="mt-20 flex justify-center items-center flex-wrap gap-4 text-xs font-black text-slate-400 uppercase tracking-widest">
            <span className="text-slate-800 bg-white px-4 py-2 rounded shadow-sm border border-slate-100">Citizen</span> <ArrowRight className="w-4 h-4"/>
            <span className="text-blue-600 bg-blue-50 px-4 py-2 rounded shadow-sm border border-blue-100">AI</span> <ArrowRight className="w-4 h-4"/>
            <span className="text-slate-800 bg-white px-4 py-2 rounded shadow-sm border border-slate-100">Officer</span> <ArrowRight className="w-4 h-4"/>
            <span className="text-slate-800 bg-white px-4 py-2 rounded shadow-sm border border-slate-100">Worker</span> <ArrowRight className="w-4 h-4"/>
            <span className="text-green-600 bg-green-50 px-4 py-2 rounded shadow-sm border border-green-100">Repair</span> <ArrowRight className="w-4 h-4"/>
            <span className="text-slate-800 bg-white px-4 py-2 rounded shadow-sm border border-slate-100">Citizen</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900">WHO BENEFITS?</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-8 bg-blue-50 border border-blue-100 rounded-2xl">
              <Users className="w-8 h-8 text-blue-600 mb-4" />
              <h3 className="font-black text-xl mb-2 text-slate-900">CITIZENS</h3>
              <p className="text-slate-600">Easy reporting and transparent tracking.</p>
            </div>
            <div className="p-8 bg-slate-50 border border-slate-200 rounded-2xl">
              <Shield className="w-8 h-8 text-slate-700 mb-4" />
              <h3 className="font-black text-xl mb-2 text-slate-900">OFFICERS</h3>
              <p className="text-slate-600">Centralized dashboard to verify, prioritize and manage reports.</p>
            </div>
            <div className="p-8 bg-slate-50 border border-slate-200 rounded-2xl">
              <Wrench className="w-8 h-8 text-slate-700 mb-4" />
              <h3 className="font-black text-xl mb-2 text-slate-900">WORKERS</h3>
              <p className="text-slate-600">Clear repair assignments and location information.</p>
            </div>
            <div className="p-8 bg-green-50 border border-green-100 rounded-2xl">
              <Building2 className="w-8 h-8 text-green-600 mb-4" />
              <h3 className="font-black text-xl mb-2 text-slate-900">COMMUNITIES</h3>
              <p className="text-slate-600">Safer and better-maintained roads.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="flex items-center gap-4 bg-slate-800 p-6 rounded-xl border border-slate-700">
      ...
      {/* 7. COMPLETE WORKFLOW */}
      <section className="py-32 px-4 bg-gradient-to-b from-blue-50 to-white text-center">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-sm font-black text-blue-600 tracking-widest uppercase mb-4">From Problem to Solution</h2>
          <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-16">THE COMPLETE WORKFLOW</h3>
          ...
          <div className="flex flex-col items-center gap-4">
            {['ROAD DAMAGE', 'REPORT', 'AI ANALYSIS', 'PRIORITY', 'OFFICER VERIFICATION', 'WORKER ASSIGNMENT', 'REPAIR', 'VERIFICATION', 'RESOLVED'].map((step, i, arr) => (
              <div key={i} className="flex flex-col items-center">
                <div className={`px-8 py-4 rounded-xl font-black tracking-widest text-lg shadow-sm border ${i === 0 || i === arr.length - 1 ? 'bg-slate-900 text-white border-slate-800' : 'bg-white text-slate-700 border-slate-200'}`}>
                  {step}
                </div>
                {i !== arr.length - 1 && <ArrowDown className="w-6 h-6 text-slate-300 my-4" />}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-4 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-200">
            <LayoutDashboard className="w-10 h-10 text-slate-700 mb-6" />
            <h2 className="text-3xl font-black text-slate-900 mb-4">OFFICER & REPAIR MANAGEMENT</h2>
            ...
            <Link to="/officer-login" className="inline-block px-6 py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-lg transition-colors">
              View Officer Portal
            </Link>
          </div>
          ...
          <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-200">
            ...
            <h2 className="text-3xl font-black text-slate-900 mb-4">FOR CITIZENS</h2>
            <p className="text-slate-600 mb-6 font-medium">Citizens can report road damage, receive a unique Report ID and track the progress of their report in real-time.</p>
            
            <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 mb-8 font-mono text-sm">
              <div className="mb-4"><span className="text-slate-400">Report ID:</span> <span className="font-bold text-blue-600">RG-20260911-001</span></div>
              <div className="text-slate-400 mb-1">Status Timeline:</div>
              <div className="text-slate-700 font-bold leading-relaxed">
                Reported → Verified → Repair Assigned → In Progress → <span className="text-green-600">Resolved</span>
              </div>
            </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900">EXPECTED IMPACT</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-6 border-l-4 border-blue-600 bg-slate-50 rounded-r-xl">
      ...
      <section className="py-24 px-4 bg-slate-900 text-white relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-slate-800 p-8 rounded-2xl border border-slate-700 group hover:border-blue-500 transition-colors">
      ...
      <section className="py-24 px-4 bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block px-4 py-2 bg-slate-100 text-slate-600 font-black text-xs uppercase tracking-widest rounded-lg mb-6">
            Future Scope
          </div>
          <h2 className="text-3xl font-black text-slate-900 mb-12">POSSIBLE FUTURE IMPROVEMENTS</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <span key={i} className="px-5 py-3 bg-slate-50 border border-slate-200 text-slate-700 font-bold text-sm rounded-full">
                {item}
              </span>
            ))}
          </div>
          <p className="text-xs text-slate-400 mt-8 uppercase tracking-wider font-bold">
      ...
      {/* 14. FINAL CTA */}
      <section className="py-32 px-4 bg-blue-600 text-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link to="/report" className="w-full sm:w-auto px-8 py-4 bg-white text-blue-600 rounded-xl font-black text-lg hover:bg-blue-50 transition-colors">
              Report Road Damage
            </Link>
            <Link to="/track" className="w-full sm:w-auto px-8 py-4 bg-blue-700 border border-blue-500 text-white rounded-xl font-bold text-lg hover:bg-blue-800 transition-colors">
              Track My Report
            </Link>
          </div>
        </div>
