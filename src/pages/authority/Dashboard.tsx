...
export const Dashboard = () => {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center"><RefreshCw className="w-8 h-8 animate-spin text-blue-600 dark:text-blue-400" /></div>;
          ...
          <div className="flex-1 relative z-0">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 z-[400] bg-white dark:bg-slate-800/95 backdrop-blur p-3 rounded-lg shadow-md border border-slate-200 dark:border-slate-700 text-xs flex flex-col gap-2 pointer-events-none">
                ...
                <div className="flex items-center gap-2"><span className="w-3 h-3 rounded-full bg-green-50 dark:bg-green-900/200 shadow-sm border border-green-600"></span> Low</div>
              </div>
            </MapContainer>
          </div>
        </div>
