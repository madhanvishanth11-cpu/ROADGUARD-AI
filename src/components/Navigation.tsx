  ...
  return (
    <nav className="bg-white/90 dark:bg-black backdrop-blur-md border-b border-gray-100 dark:border-[#2A2A2A] sticky top-0 z-50 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-[96px] sm:h-[120px]">
          <div className="flex items-center gap-4">
            <Link to="/" className="flex-shrink-0 flex items-center gap-2">
              <img 
                src="/branding/roadguard-logo.png" 
                alt="RoadGuard AI" 
                className="h-[72px] sm:h-[96px] w-auto object-contain dark:bg-white dark:rounded-md dark:p-0.5 transition-colors" 
              />
